...
# EFI System Partition, automounted on access (matches RegicideOSArch).
LABEL=EFI     /efi    vfat    defaults,noatime,noauto,x-systemd.automount,x-systemd.idle-timeout=60 0 2
EOF
