...
6. Execute Phase 1 → contracts, data-model.md, quickstart.md, agent-specific template file (e.g., `AGENTS.md` for your AI assistant, `.github/copilot-instructions.md` for GitHub Copilot, `GEMINI.md` for Gemini CLI, `QWEN.md` for Qwen Code or `OPENCODE.md` for opencode).
...
5. **Update agent file incrementally** (O(1) operation):
    - Run `scripts/update-agent-context.sh agent` for your AI assistant
